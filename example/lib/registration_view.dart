        ...
        body: Form(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text("Please provide a unique Organization and User identifier to register your device with the Demo Server."),
                const Text(""),
                const Text("You will access your results at the following url:"),
                Text("${ENV.TRACKER_HOST}/$_orgname", style: TextStyle(fontStyle: FontStyle.italic, fontWeight: FontWeight.bold)),
                const Text(""),
                Text("$_deviceId", textAlign: TextAlign.center, style: TextStyle(fontStyle: FontStyle.italic, fontWeight: FontWeight.bold, fontSize: 16.0)),
                TextFormField(
